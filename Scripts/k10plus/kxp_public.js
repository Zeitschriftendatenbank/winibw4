...
function __anzeigeKurzVoll(){
	var strScreen = application.activeWindow.getVariable("scr");
	if (strScreen != "7A" && strScreen != "8A"){
		application.messageBox("Prüfung Anzeige", "Diese Funktion können Sie nur in der Kurz- oder Vollanzeige ausführen.", "alert-icon");
		return false;
	}
}
function __anzeigeKurz(){
	if (application.activeWindow.getVariable("scr") != "7A"){
		application.messageBox("Prüfung Anzeige", "Diese Funktion können Sie nur in der Kurzanzeige ausführen.", "alert-icon");
		return false;
	}
}
function __anzeigeVoll(){
	if (application.activeWindow.getVariable("scr") != "8A"){
		application.messageBox("Prüfung Anzeige", "Diese Funktion können Sie nur in der Vollanzeige ausführen.", "alert-icon");
		return false;
	}
}
