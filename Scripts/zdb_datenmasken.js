...
{
    __DatenmaskeEinfuegen("maskeAbxzTr_zdb.txt");
}

function zdb_DatenmaskeObxz()
{
    __DatenmaskeEinfuegen("maskeObxz_zdb.txt");
}

function zdb_DatenmaskeAdxz()
{
    __DatenmaskeEinfuegen("maskeAdxz_zdb.txt");
}

function zdb_DatenmaskeOdxz()
{
    __DatenmaskeEinfuegen("maskeOdxz_zdb.txt");
}
/*
